    ...
    { 
        ...
        if(in_time)
        {
            ...
            else
            {
                ...
                aantalCorrect ++;
                var sesScore = score === undefined ? 0 : score;
                ...
                pageCorrect = '<div class="overlay page"><h2>Al ' + (aantalCorrect + 1) + ' goed</h2><div class="scores"><p><strong>'+sesScore+'</strong><br>Score</p><p><strong>'+(aantalCorrect + 1)+'</strong><br>Aantal rondes</p></div><div class="action"><a href="#" id="next">VOLGENDE</a></div></div>';
            ...
            if(answer === 2)
            {
                imageUrl1 = pageCorrect;
                imageUrl2 = imageCorrect;
            }
            var data = {
